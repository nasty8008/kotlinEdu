...
fun main() {
    val regBook1 = RegularBook("Анна Каренина", "Лев Толстой")
    val regBook2 = RegularBook("Анна Каренина", "Лев Толстой")

    val dataBook1 = DataBook("Анна Каренина", "Лев Толстой")
    val dataBook2 = DataBook("Анна Каренина", "Лев Толстой")
